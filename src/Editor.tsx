...
import { Highlight } from './plugins/FindAndReplacePlugin';
...
export default function Editor(): JSX.Element {
  ...
  const [listOffset, setListOffset] = useState<NodekeyOffset[]>([]);
      ...
      <div
        ...
        {isRichText ? (
          <>
            ...
            <PageBreakPlugin />
            <LayoutPlugin />
            {/* {(listOffset.length > 0) &&  listOffset.map((offset,index:number) =>  */}
            {floatingAnchorElem &&
              (
                <>
