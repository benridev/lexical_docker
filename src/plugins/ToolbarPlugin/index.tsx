...
import { FindTextDialog } from '../FindAndReplacePlugin';
import DropdownFindDialog from '../../ui/DropdownFindDialog';
...
export default function ToolbarPlugin({
  ...
  setReplaceString: Dispatch<string>;
    ...
    <div>
      <div className="toolbar">
        ...
        {blockType === 'code' ? (
          ...
          <>
            ...
            <DropDown
              ...
              <span className="text">Find Text</span>
            </DropDownItem> */}
              <DropDownItem
                onClick={() => {
        ...
        <DropdownFindDialog
          ...
          buttonAriaLabel="Find and Replace "
          buttonIconClassName="icon find"
          onChange={setSearchString}
      ...
      {/* <FindTextDialog onChange={setSearchString}/> */}
    </div>
  );
}
